  ...
  return (
    <Box className="min-h-screen bg-gradient-to-b from-sky-100 via-gray-50 to-white pb-20">
      <Box className="px-4 pt-10 pb-4">
        <Title order={3} className="text-gray-800 text-center text-lg font-semibold">学习中心</Title>
      </Box>

      <Container className="max-w-md mx-auto px-4 py-3 space-y-3.5">
        <Card className="bg-gradient-to-r from-orange-500 to-amber-500" radius="md" p="4">
          <Box className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
              <BarChart3 className="w-5 h-5 text-white" />
            </div>
            <div className="flex-1">
              <Title order={4} className="text-white text-sm font-semibold">每日一练</Title>
              <Text className="text-white/80 text-xs">每天进步一点点</Text>
            </div>
            <Button variant="outline" color="white" size="sm" radius="md" onClick={() => router.push('/quiz')}>
              开始练习
            </Button>
          </Box>
        </Card>
        ...
        <Card shadow="sm" radius="md" p="4" className="border border-gray-100">
          <div className="grid grid-cols-4 gap-3">
            <div className="text-center">
              <Text className="text-xl font-bold text-green-500">{dailyStats.today}</Text>
              <Text className="text-xs text-gray-500">今日学习</Text>
            </div>
            <div className="text-center">
              <Text className="text-xl font-bold text-blue-500">{dailyStats.accuracy}</Text>
              <Text className="text-xs text-gray-500">正确率</Text>
            </div>
            <div className="text-center">
              <Text className="text-xl font-bold text-orange-500">{dailyStats.streak}</Text>
              <Text className="text-xs text-gray-500">连续天数</Text>
            </div>
            <div className="text-center">
              <Text className="text-xl font-bold text-purple-500">{dailyStats.total}</Text>
        ...
        <Card shadow="sm" radius="md" p="4" className="border border-gray-100">
          <Title order={4} className="text-gray-800 mb-3 text-base font-semibold">知识分类</Title>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 text-left">
                    <Text className="text-sm font-medium text-gray-800">{category.label}</Text>
                    <Text className="text-xs text-gray-400">{category.count}篇</Text>
                  </div>
        ...
        <Box className="flex items-center justify-between mb-2">
          <Title order={4} className="text-gray-800 text-base font-semibold">热门知识</Title>
          <Button size="xs" variant="link" color="green" className="h-auto px-2">更多</Button>
        </Box>
        <Card shadow="sm" radius="md" p="4" className="border border-gray-100">
